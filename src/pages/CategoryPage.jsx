...
const CategoryPage = () => {
  ...
  const categoryThemes = {
    engineering: {
      ...
      button: 'bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 shadow-sm',
    ...
    medical: {
      ...
      button: 'bg-green-50 hover:bg-green-100 text-green-700 border border-green-200 shadow-sm',
    ...
    management: {
      ...
      button: 'bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200 shadow-sm',
    ...
    'arts-humanities': {
      ...
      button: 'bg-amber-50 hover:bg-amber-100 text-amber-700 border border-amber-200 shadow-sm',
    ...
    default: {
      ...
      button: 'bg-gray-50 hover:bg-gray-100 text-gray-700 border border-gray-200 shadow-sm',
